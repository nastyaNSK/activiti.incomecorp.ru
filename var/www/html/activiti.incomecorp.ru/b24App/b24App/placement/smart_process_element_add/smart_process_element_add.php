...
file_put_contents(__DIR__ . '/tmplog.txt', print_r($_REQUEST, true));
...
<? if(!($_REQUEST['entity_type_id'] || file_exists($file))):?>
    <form method="get" action="https://activiti.incomecorp.ru/placement/">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="entity_type_id" name="entity_type_id">
            <input type="text" name="placement" value="smart_process_element_add" style="display:none;">
            ...
            <input type="text" style="display:none;" value="smart_process_element_add" name="placement">
        </div>
